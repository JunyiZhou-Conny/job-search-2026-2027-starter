...
Attach Perfect Resume (Polar/Simplify stored name).
If the widget is empty and Perfect Resume cannot be uploaded, do not
upload `resumes/base/JZ_resume.pdf` or `ai_infra_v1`.
