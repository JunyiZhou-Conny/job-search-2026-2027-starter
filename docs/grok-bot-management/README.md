...
- [GROK_BOT_HANDOFF.md](GROK_BOT_HANDOFF.md) — **live** CEO paste (assign + Ashby fill)
- [ARCHITECT.md](ARCHITECT.md) — Architect Settings paste. Outside every company. Spawns Bots. Not apply-only.
- [BOT_DESCRIPTIONS.md](BOT_DESCRIPTIONS.md) — apply company Settings pastes. CEO of Auto Application runs this company.
