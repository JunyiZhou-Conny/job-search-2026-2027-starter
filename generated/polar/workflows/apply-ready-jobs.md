...
workflow_version: 2026-09-15.fast-validation+0450e9243133
status: production
enabled: true
...
- work_authorization: future_sponsorship, h1b_named, citizenship, visa_type, authorized_for_any_employer, currently_authorized, work_authorization_wording. knowledge/work_authorization.yaml stays authoritative. Classify the exact question with polar_policy.auth_form_action. Answer only that semantic.
