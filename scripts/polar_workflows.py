...
def render_apply(operator: Dict[str, Any]) -> str:
    ...
    return _lines(
        [
            ...
            f"   Incident repeat_key {COPILOT_EMAIL_REPEAT_KEY} if Copilot put the school mailbox there.",
            ...
            f"    If the page confirmation is missing or the queue readback does not match, write SUBMISSION_UNKNOWN. Incident repeat_key {SUBMIT_PROOF_REPEAT_KEY}. Do not click Submit a second time.",
