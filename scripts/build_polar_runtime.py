...
def compile_sections() -> Dict[str, str]:
    ...
    section_l = "\n".join(
        [
            ...
            f"That abort uses repeat_key {CONTROL_KEY_DUPLICATE_REPEAT_KEY}. Do not invent control_duplicate_key variants.",
    ...
    section_n = "\n".join(
        [
            ...
            f"Jobright Matches onboarding uses repeat_key {JOBRIGHT_ONBOARDING_REPEAT_KEY}.",
            "Do not invent jobright_onboarding_* variants.",
            f"Degree-level apply-time skips share repeat_key {DEGREE_LEVEL_REPEAT_KEY}.",
            f"Duplicate control-tab keys use repeat_key {CONTROL_KEY_DUPLICATE_REPEAT_KEY}.",
